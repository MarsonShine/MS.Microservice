...
foreach (var size in new[] { 1, 2, 8 })
{
    ...
    var topology = new MessageTopology([MessageContract.For<Changed>("changed", BenchmarkMessageJsonContext.Default.Changed)], subscriptions);
...
[JsonSerializable(typeof(Changed))]
internal partial class BenchmarkMessageJsonContext : JsonSerializerContext;
