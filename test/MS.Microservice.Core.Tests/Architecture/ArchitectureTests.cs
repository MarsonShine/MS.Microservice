...
public class ArchitectureTests
{
    ...
    [Fact]
    public void ObservabilityPackage_ShouldNot_DependOn_WebSampleDomainOrOrm()
    {
        var referencedAssemblies = typeof(MS.Microservice.Infrastructure.Telemetry.PlatformMetrics)
            .Assembly
            .GetReferencedAssemblies()
            .Select(assembly => assembly.Name)
            .ToArray();
    ...
    [Fact]
    public void ExcelPackage_ShouldNot_DependOn_WebSampleDomainOrOrm()
    {
        var referencedAssemblies = typeof(MS.Microservice.Infrastructure.Utils.ExcelHelper)
            .Assembly
            .GetReferencedAssemblies()
            .Select(assembly => assembly.Name)
            .ToArray();
    ...
    [Fact]
    public void DomainPrimitivesPackage_ShouldNot_DependOn_WebSampleDomainOrOrm()
    {
        var referencedAssemblies = typeof(MS.Microservice.Core.Domain.Entity.IEntity)
            .Assembly
            .GetReferencedAssemblies()
            .Select(assembly => assembly.Name)
            .ToArray();
