...
> 译者注：关于 Quorum 相关知识点，可以详见[《分布式解决模式-Quorum》](../patterns-of-distributed-systems/Quorum.md)
...
> 译者注：Leader 选举是通过 Zookeeper 完成的，关于选举相关知识点，可以详见[《分布式解决模式-Leader-Followers》](../patterns-of-distributed-systems/Leader-And-Followers.md)。
...
> 译者注：关于 Gossip 协议可详见[《分布式解决模式-Gossip 协议》](../patterns-of-distributed-systems/Gossip-Dissemination.md)
...
> 关于日志分段相关只是可以详见[《分布式解决模式-日志分段》](../patterns-of-distributed-systems/Segmented-Log.md)。
>
> 关于日志压缩的主要过程可以阅读《设计数据密集型应用》，这里给出译者相关的了解内容，传送门：[日志结构的合并树](../distribution-lock/time-series-database.md#%E6%97%A5%E5%BF%97%E7%BB%93%E6%9E%84%E7%9A%84%E5%90%88%E5%B9%B6%E6%A0%91lsm-tree)
