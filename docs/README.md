...
- [`src` 基础设施性能检查](infrastructure-performance-review-2026-09-23.md)：逐项目的测量、改动与未改动原因。
- [AI、Logging、Messaging、Persistence 性能检查](extension-modules-performance-review-2026-09-23.md)：四个模块的测量、提交及 AOT 边界。
